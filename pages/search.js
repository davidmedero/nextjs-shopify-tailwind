...
const filteredProducts = products.filter(product => {
    if (query === '') {
        ...
        return product
    } else if (product.node.tags.some(tag => query?.toLowerCase().split(' ').includes(tag)) && query?.toLowerCase().split(' ').filter(el => el !== '').length <= 1) {
        return product
        ...
        return product
    } else if (product.node.tags.some(tag => query?.toLowerCase().split(' ').includes(tag)) && product.node.variants.edges[0]?.node.selectedOptions[0].name == 'Size' && ((product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 1)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 2)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 3)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 5)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 6)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 7)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 8)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 9)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 10)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 11)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 12)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 13)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 14)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 15)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, product.node.title.length)).some(el => query?.toLowerCase().split(' ').includes(el))))) {
        return product
    } else if (product.node.tags.some(tag => query?.toLowerCase().split(' ').includes(tag)) && product.node.variants.edges[0]?.node.selectedOptions[0].name == 'Color' && ((product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 1)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 2)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 3)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 5)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 6)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 7)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 8)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 9)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 10)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 11)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 12)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 13)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 14)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, 15)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.title.toLowerCase().split(' ').map(string => string.slice(0, product.node.title.length)).some(el => query?.toLowerCase().split(' ').includes(el))))) {
        return product
