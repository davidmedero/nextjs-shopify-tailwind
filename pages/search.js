...
const filteredProducts = products.filter(product => {
    ...
    } else if (product.node.variants.edges[0]?.node.selectedOptions[0].name == 'Color' && product.node.variants.edges[14]?.node.selectedOptions[1].value == '0' && query?.toLowerCase().split(' ').filter(el => el !== '').length <= 1 && ((product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 3)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 5)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 6)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 7)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 8)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 9)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 10)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 11)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 12)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 13)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 14)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 15)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[14].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, product.node.title.length)).some(el => query?.toLowerCase().split(' ').includes(el))))) {
        return product
    ...
    } else if (product.node.variants.edges[0]?.node.selectedOptions[0].name == 'Color' && product.node.variants.edges[28]?.node.selectedOptions[1].value == '0' && query?.toLowerCase().split(' ').filter(el => el !== '').length <= 1 && ((product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 3)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 4)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 5)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 6)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 7)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 8)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 9)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 10)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 11)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 12)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 13)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 14)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, 15)).some(el => query?.toLowerCase().split(' ').includes(el))) || (product.node.variants.edges[28].node.selectedOptions[0]?.value.toLowerCase().split(' ').map(string => string.slice(0, product.node.title.length)).some(el => query?.toLowerCase().split(' ').includes(el))))) {
        return product
