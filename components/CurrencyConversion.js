        ...
        <div ref={ref} onClick={() => toggleCurrencies()}>
            {
              (currentCurrency === 'USD' || currentCurrency === 'GBP' || currentCurrency === 'EUR') ? '' : (
                <svg xmlns="http://www.w3.org/2000/svg" class="h-[25px] w-[25px] hover:scale-[1.3] transition-all duration-200 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2">
