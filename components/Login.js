...
export default function Login({ show, onClose }) {
    ...
    const modalContent = show ? (
        <div onClick={() => onClose()}>
        <div id="authentication-modal" aria-hidden="true" class="flex overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center h-modal md:h-full md:inset-0 bg-black bg-opacity-50">
        <div onClick={e => e.stopPropagation()} class="relative px-4 w-full max-w-md h-full md:h-auto">
