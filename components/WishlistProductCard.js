        ...
        <div className="w-full bg-gray-200 overflow-hidden">
            ...
            <span 
              ...
              className="absolute right-[6px] top-1 z-10">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 cursor-pointer" fill={heartFill ? "#ff00a7" : "none"} viewBox="0 0 24 24" stroke={heartFill ? "#ff00a7" : "white"} strokeWidth="2">
