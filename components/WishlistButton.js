...
export default function SignInButton() {
  ...
  return (
    <div>
      {!session && (
        <>
        <button onClick={() => setShowModal(true)} className='xxs:hidden wish:!block px-[6px] relative hover:scale-[1.3] transition-all duration-200 ease-in-out' type="button" data-modal-toggle="authentication-modal">
      ...
      <button className='xxs:hidden wish:!block px-[6px] relative hover:scale-[1.3] transition-all duration-200 ease-in-out' type="button">
