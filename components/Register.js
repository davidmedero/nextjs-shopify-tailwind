      ...
      <div>
        {
          ...
          <form class="px-6 space-y-6 lg:px-8 pb-8">
                ...
                <div>
                    ...
                    id="fname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:!border-pink-500 focus:!outline-pink-500 focus:!bg-pink-100 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
                </div>
                <div>
                    <input 
                    type="text" 
                ...
                <button type="button" class="transition-all ease-in-out duration-600 w-full text-white bg-pink-400 hover:bg-pink-500 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800">Register</button>
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                Already registered? <a onClick={() => setShow(false)} class="text-pink-500 hover:text-pink-800">Log In</a>
                </div>
            </form>
            : <Login />
        }
