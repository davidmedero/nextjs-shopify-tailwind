...
export default function SignInButton() {
  ...
  return (
    <div>
      {!session && (
        <>
        <button onClick={() => setShowModal(true)} className='relative left-[6px] highlight-removal flex items-center mr-5 hover:scale-[1.3] transition-all duration-200 ease-in-out' type="button" data-modal-toggle="authentication-modal">
